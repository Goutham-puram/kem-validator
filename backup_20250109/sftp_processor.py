...
class FTPProcessor:
    ...
    def list_ftp_files(self, directory: str = None) -> List[str]:
        ...
        # If you added _chdir_strict earlier (recommended), use it:
        try:
    ...
    def move_ftp_file(self, source: str, destination: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Moved on FTP: {source} -> {destination}")
            return True
        except Exception as e:
    ...
    def process_ftp_file(self, filename: str) -> Dict:
        ...
        # Setup paths
        remote_inbox_path = f"{self.ftp_config.ftp_inbox}/{filename}"
        ...
        try:
            ...
            if result['status'] == 'success' and self.ftp_config.upload_results:
                ...
                if 'csv_path' in result:
                    ...
                    remote_csv_path = f"{self.ftp_config.ftp_results}/{csv_filename}"
                ...
                if self.ftp_config.archive_on_ftp:
                    if result['validation_status'] == 'passed':
                        archive_dir = self.ftp_config.ftp_processed
                    else:
                        archive_dir = self.ftp_config.ftp_invalid
                    ...
                    # Move file on FTP
                    self.move_ftp_file(remote_inbox_path, archive_path)
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            test_path = f"{self.ftp_config.ftp_results}/{test_file}"
